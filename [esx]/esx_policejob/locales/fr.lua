Locales['fr'] = {
  ...
  ['lieutenant_wear'] = 'tenue Policier',
  ['commandant_wear'] = 'tenue Policier',
  ...
  ['traffic_offense'] = 'code de la route et vitesse',
  ['minor_offense'] = ' outrage , menace , armement  ',
  ['average_offense'] = 'vole,drogue,braquage,ôtage',
  ['major_offense'] = 'tentative,meutre,escroquerie',
  ['fine_total'] = 'amende : ',
  -- Vehicle Info Menu
  ['plate'] = 'N°: ',
  ...
  -- Authorized Vehicles
  ['police'] = 'véhicule de cadet',
  ['police2'] = 'véhicule des sergents',
  ['police3'] = 'véhicule du lieutenant',
  ['police4'] = 'véhicule banalisé',
  ['policeb'] = 'moto',
 ...
 --permis
  ...
  --le vestiares
  ['veste_wear'] = 'Mettre le gillet parballes',
  ['gilet_wear'] = 'Retirer le gillet par balles',
  ['sergent_wear'] = 'tenue Policier',
  ['cadet_wear'] = 'tenue Policier',
}
