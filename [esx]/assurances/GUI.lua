...
RegisterNetEvent("GUIAssureur:Title")
AddEventHandler("GUIAssureur:Title", function(title)
	Menu.Title(title)
end)

RegisterNetEvent("GUIAssureur:Option")
AddEventHandler("GUIAssureur:Option", function(option, cb)
	cb(Menu.Option(option))
end)

RegisterNetEvent("GUIAssureur:Bool")
AddEventHandler("GUIAssureur:Bool", function(option, bool, cb)
	Menu.Bool(option, bool, function(data)
		cb(data)
	end)
end)

RegisterNetEvent("GUIAssureur:Int")
AddEventHandler("GUIAssureur:Int", function(option, int, min, max, cb)
	Menu.Int(option, int, min, max, function(data)
		cb(data)
	end)
end)

RegisterNetEvent("GUIAssureur:StringArray")
AddEventHandler("GUIAssureur:StringArray", function(option, array, position, cb)
	Menu.StringArray(option, array, position, function(data)
		cb(data)
	end)
end)

RegisterNetEvent("GUIAssureur:Update")
AddEventHandler("GUIAssureur:Update", function()
